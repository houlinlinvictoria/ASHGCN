...
from data_utils import ABSADatesetReader#若为中文数据集需要换为data_utils_chinese
from models import  AS_HGCN
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='as_hgcn', type=str)
    parser.add_argument('--dataset', default='rest15', type=str, help='covid-E, covid-C, lap14, rest15')
    ...
    input_colses = {
        'as_hgcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph'],
    }
    initializers = {
