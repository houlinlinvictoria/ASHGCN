...
class ABSADatesetReader:
    ...
    def __init__(self, dataset='covid-E', embed_dim=300):
        ...
        fname = {
            ...
            'covid-C': {
                'train': './datasets/covid-2019/covid-2019_train.raw',
                'test': './datasets/covid-2019/covid-2019_test.raw'
            },
            'covid-E': {
                'train': './datasets/covid-2019/covid-2019-en_train.raw',
                'test': './datasets/covid-2019/covid-2019-en_test.raw'
            },
        }
